...
- `docker-compose.yml`: упрощённый запуск в контейнере.
    

## Требования

- **Python 3.9+** (либо **Docker**, если хотите запускать всё в контейнере).
...
⭐️ Если проект оказался полезен, поддержите его звёздочкой на GitHub!
